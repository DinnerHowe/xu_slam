...
(cl:defmethod cl:initialize-instance :after ((m <Spawn-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Spawn-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tf_nodes-srv:<Spawn-request> is deprecated: use tf_nodes-srv:Spawn-request instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <Spawn-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tf_nodes-srv:x-val is deprecated.  Use tf_nodes-srv:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <Spawn-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tf_nodes-srv:y-val is deprecated.  Use tf_nodes-srv:y instead.")
  (y m))

(cl:ensure-generic-function 'theta-val :lambda-list '(m))
(cl:defmethod theta-val ((m <Spawn-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tf_nodes-srv:theta-val is deprecated.  Use tf_nodes-srv:theta instead.")
  (theta m))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <Spawn-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tf_nodes-srv:name-val is deprecated.  Use tf_nodes-srv:name instead.")
  (name m))
...
(cl:defmethod cl:initialize-instance :after ((m <Spawn-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Spawn-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tf_nodes-srv:<Spawn-response> is deprecated: use tf_nodes-srv:Spawn-response instead.")))
