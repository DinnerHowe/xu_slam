...
(cl:defmethod cl:initialize-instance :after ((m <SetPen-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetPen-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tf_nodes-srv:<SetPen-request> is deprecated: use tf_nodes-srv:SetPen-request instead.")))

(cl:ensure-generic-function 'r-val :lambda-list '(m))
(cl:defmethod r-val ((m <SetPen-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tf_nodes-srv:r-val is deprecated.  Use tf_nodes-srv:r instead.")
  (r m))

(cl:ensure-generic-function 'g-val :lambda-list '(m))
(cl:defmethod g-val ((m <SetPen-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tf_nodes-srv:g-val is deprecated.  Use tf_nodes-srv:g instead.")
  (g m))

(cl:ensure-generic-function 'b-val :lambda-list '(m))
(cl:defmethod b-val ((m <SetPen-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tf_nodes-srv:b-val is deprecated.  Use tf_nodes-srv:b instead.")
  (b m))

(cl:ensure-generic-function 'width-val :lambda-list '(m))
(cl:defmethod width-val ((m <SetPen-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tf_nodes-srv:width-val is deprecated.  Use tf_nodes-srv:width instead.")
  (width m))

(cl:ensure-generic-function 'off-val :lambda-list '(m))
(cl:defmethod off-val ((m <SetPen-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tf_nodes-srv:off-val is deprecated.  Use tf_nodes-srv:off instead.")
  (off m))
...
(cl:defmethod cl:initialize-instance :after ((m <SetPen-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetPen-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tf_nodes-srv:<SetPen-response> is deprecated: use tf_nodes-srv:SetPen-response instead.")))
