...
(cl:defmethod cl:initialize-instance :after ((m <Transmit>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Transmit)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name voice_interface-msg:<Transmit> is deprecated: use voice_interface-msg:Transmit instead.")))

(cl:ensure-generic-function 'transmit-val :lambda-list '(m))
(cl:defmethod transmit-val ((m <Transmit>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader voice_interface-msg:transmit-val is deprecated.  Use voice_interface-msg:transmit instead.")
  (transmit m))

(cl:ensure-generic-function 'object-val :lambda-list '(m))
(cl:defmethod object-val ((m <Transmit>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader voice_interface-msg:object-val is deprecated.  Use voice_interface-msg:object instead.")
  (object m))

(cl:ensure-generic-function 'didian-val :lambda-list '(m))
(cl:defmethod didian-val ((m <Transmit>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader voice_interface-msg:didian-val is deprecated.  Use voice_interface-msg:didian instead.")
  (didian m))
