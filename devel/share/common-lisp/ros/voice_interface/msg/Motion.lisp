...
(cl:defmethod cl:initialize-instance :after ((m <Motion>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Motion)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name voice_interface-msg:<Motion> is deprecated: use voice_interface-msg:Motion instead.")))

(cl:ensure-generic-function 'motion-val :lambda-list '(m))
(cl:defmethod motion-val ((m <Motion>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader voice_interface-msg:motion-val is deprecated.  Use voice_interface-msg:motion instead.")
  (motion m))

(cl:ensure-generic-function 'direction-val :lambda-list '(m))
(cl:defmethod direction-val ((m <Motion>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader voice_interface-msg:direction-val is deprecated.  Use voice_interface-msg:direction instead.")
  (direction m))

(cl:ensure-generic-function 'pattern-val :lambda-list '(m))
(cl:defmethod pattern-val ((m <Motion>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader voice_interface-msg:pattern-val is deprecated.  Use voice_interface-msg:pattern instead.")
  (pattern m))

(cl:ensure-generic-function 'stepcount-val :lambda-list '(m))
(cl:defmethod stepcount-val ((m <Motion>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader voice_interface-msg:stepcount-val is deprecated.  Use voice_interface-msg:stepcount instead.")
  (stepcount m))

(cl:ensure-generic-function 'metric-val :lambda-list '(m))
(cl:defmethod metric-val ((m <Motion>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader voice_interface-msg:metric-val is deprecated.  Use voice_interface-msg:metric instead.")
  (metric m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <Motion>) ostream)
  ...
  (cl:let* ((signed (cl:slot-value msg 'pattern)) (unsigned (cl:if (cl:< signed 0) (cl:+ signed 18446744073709551616) signed)))
    (cl:write-byte (cl:ldb (cl:byte 8 0) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) unsigned) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Motion>) istream)
  "Deserializes a message object of type '<Motion>"
    ...
    (cl:let ((unsigned 0))
      ...
      (cl:setf (cl:ldb (cl:byte 8 48) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 56) unsigned) (cl:read-byte istream))
      (cl:setf (cl:slot-value msg 'pattern) (cl:if (cl:< unsigned 9223372036854775808) unsigned (cl:- unsigned 18446744073709551616))))
    (cl:let ((unsigned 0))
      (cl:setf (cl:ldb (cl:byte 8 0) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) unsigned) (cl:read-byte istream))
