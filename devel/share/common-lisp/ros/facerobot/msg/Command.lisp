...
(cl:defclass <Command> (roslisp-msg-protocol:ros-message)
  ((my_motion
    :reader my_motion
    :initarg :my_motion
    :type facerobot-msg:Motion
    :initform (cl:make-instance 'facerobot-msg:Motion))
   (my_navigation
    :reader my_navigation
    :initarg :my_navigation
    :type facerobot-msg:Navigation
    :initform (cl:make-instance 'facerobot-msg:Navigation))
   (my_send
    :reader my_send
    :initarg :my_send
    :type facerobot-msg:Transmit
    :initform (cl:make-instance 'facerobot-msg:Transmit))
   (my_get
    :reader my_get
    :initarg :my_get
    :type facerobot-msg:Transmit
...
(cl:defmethod cl:initialize-instance :after ((m <Command>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Command)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name facerobot-msg:<Command> is deprecated: use facerobot-msg:Command instead.")))

(cl:ensure-generic-function 'my_motion-val :lambda-list '(m))
(cl:defmethod my_motion-val ((m <Command>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader facerobot-msg:my_motion-val is deprecated.  Use facerobot-msg:my_motion instead.")
  (my_motion m))

(cl:ensure-generic-function 'my_navigation-val :lambda-list '(m))
(cl:defmethod my_navigation-val ((m <Command>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader facerobot-msg:my_navigation-val is deprecated.  Use facerobot-msg:my_navigation instead.")
  (my_navigation m))

(cl:ensure-generic-function 'my_send-val :lambda-list '(m))
(cl:defmethod my_send-val ((m <Command>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader facerobot-msg:my_send-val is deprecated.  Use facerobot-msg:my_send instead.")
  (my_send m))

(cl:ensure-generic-function 'my_get-val :lambda-list '(m))
(cl:defmethod my_get-val ((m <Command>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader facerobot-msg:my_get-val is deprecated.  Use facerobot-msg:my_get instead.")
  (my_get m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Command>)))
  ...
  (cl:format cl:nil "Motion my_motion~%Navigation my_navigation~%Transmit my_send~%Transmit my_get~%~%================================================================================~%MSG: facerobot/Motion~%bool motion~%int64 direction~%int64 pattern~%int64 stepcount~%int64 metric~%~%================================================================================~%MSG: facerobot/Navigation~%bool navigation~%int64 go~%int64 direct~%int64 columnNum~%int64 rowNum~%~%================================================================================~%MSG: facerobot/Transmit~%bool transmit~%int64 object~%int64 didian~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Command)))
  "Returns full string definition for message of type 'Command"
  (cl:format cl:nil "Motion my_motion~%Navigation my_navigation~%Transmit my_send~%Transmit my_get~%~%================================================================================~%MSG: facerobot/Motion~%bool motion~%int64 direction~%int64 pattern~%int64 stepcount~%int64 metric~%~%================================================================================~%MSG: facerobot/Navigation~%bool navigation~%int64 go~%int64 direct~%int64 columnNum~%int64 rowNum~%~%================================================================================~%MSG: facerobot/Transmit~%bool transmit~%int64 object~%int64 didian~%~%~%"))
