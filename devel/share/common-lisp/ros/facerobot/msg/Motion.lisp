...
(cl:defmethod cl:initialize-instance :after ((m <Motion>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Motion)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name facerobot-msg:<Motion> is deprecated: use facerobot-msg:Motion instead.")))

(cl:ensure-generic-function 'motion-val :lambda-list '(m))
(cl:defmethod motion-val ((m <Motion>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader facerobot-msg:motion-val is deprecated.  Use facerobot-msg:motion instead.")
  (motion m))

(cl:ensure-generic-function 'direction-val :lambda-list '(m))
(cl:defmethod direction-val ((m <Motion>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader facerobot-msg:direction-val is deprecated.  Use facerobot-msg:direction instead.")
  (direction m))

(cl:ensure-generic-function 'pattern-val :lambda-list '(m))
(cl:defmethod pattern-val ((m <Motion>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader facerobot-msg:pattern-val is deprecated.  Use facerobot-msg:pattern instead.")
  (pattern m))

(cl:ensure-generic-function 'stepcount-val :lambda-list '(m))
(cl:defmethod stepcount-val ((m <Motion>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader facerobot-msg:stepcount-val is deprecated.  Use facerobot-msg:stepcount instead.")
  (stepcount m))

(cl:ensure-generic-function 'metric-val :lambda-list '(m))
(cl:defmethod metric-val ((m <Motion>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader facerobot-msg:metric-val is deprecated.  Use facerobot-msg:metric instead.")
  (metric m))
