...
(cl:defmethod cl:initialize-instance :after ((m <Navigation>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Navigation)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name facerobot-msg:<Navigation> is deprecated: use facerobot-msg:Navigation instead.")))

(cl:ensure-generic-function 'navigation-val :lambda-list '(m))
(cl:defmethod navigation-val ((m <Navigation>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader facerobot-msg:navigation-val is deprecated.  Use facerobot-msg:navigation instead.")
  (navigation m))

(cl:ensure-generic-function 'go-val :lambda-list '(m))
(cl:defmethod go-val ((m <Navigation>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader facerobot-msg:go-val is deprecated.  Use facerobot-msg:go instead.")
  (go m))

(cl:ensure-generic-function 'direct-val :lambda-list '(m))
(cl:defmethod direct-val ((m <Navigation>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader facerobot-msg:direct-val is deprecated.  Use facerobot-msg:direct instead.")
  (direct m))

(cl:ensure-generic-function 'columnNum-val :lambda-list '(m))
(cl:defmethod columnNum-val ((m <Navigation>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader facerobot-msg:columnNum-val is deprecated.  Use facerobot-msg:columnNum instead.")
  (columnNum m))

(cl:ensure-generic-function 'rowNum-val :lambda-list '(m))
(cl:defmethod rowNum-val ((m <Navigation>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader facerobot-msg:rowNum-val is deprecated.  Use facerobot-msg:rowNum instead.")
  (rowNum m))
