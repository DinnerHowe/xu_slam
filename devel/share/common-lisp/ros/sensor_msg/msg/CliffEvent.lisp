...
(cl:defmethod cl:initialize-instance :after ((m <CliffEvent>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CliffEvent)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sensor_msg-msg:<CliffEvent> is deprecated: use sensor_msg-msg:CliffEvent instead.")))

(cl:ensure-generic-function 'sensor-val :lambda-list '(m))
(cl:defmethod sensor-val ((m <CliffEvent>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sensor_msg-msg:sensor-val is deprecated.  Use sensor_msg-msg:sensor instead.")
  (sensor m))
...
(cl:defmethod bottom-val ((m <CliffEvent>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sensor_msg-msg:bottom-val is deprecated.  Use sensor_msg-msg:bottom instead.")
  (bottom m))
