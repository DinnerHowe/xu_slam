"""autogenerated by genpy from facerobot/Command.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct

import facerobot.msg

class Command(genpy.Message):
  _md5sum = "3cbdeafeecf997d6c967c6edbf968861"
  _type = "facerobot/Command"
...
"""
  ...
  _slot_types = ['facerobot/Motion','facerobot/Navigation','facerobot/Transmit','facerobot/Transmit']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.my_motion is None:
        self.my_motion = facerobot.msg.Motion()
      if self.my_navigation is None:
        self.my_navigation = facerobot.msg.Navigation()
      if self.my_send is None:
        self.my_send = facerobot.msg.Transmit()
      if self.my_get is None:
        self.my_get = facerobot.msg.Transmit()
    else:
      self.my_motion = facerobot.msg.Motion()
      self.my_navigation = facerobot.msg.Navigation()
      self.my_send = facerobot.msg.Transmit()
