...
class listener():
 ...
 def tfcallback(self,data):# or robot_pose_ekf/robot_pose_ekf 
 ...
 def __init__(self):
  ...
  #rospy.Subscriber("robot_odom", robot_odom, self.tfcallback) # or robot_pose_ekf/robot_pose_ekf 
