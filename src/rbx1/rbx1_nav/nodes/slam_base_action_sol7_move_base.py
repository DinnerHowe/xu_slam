...
""" slam_base_action_sol_laseravoid.py 

- Version 5.1 2015/7/27

this is base_scan_action module for SLAM

marker cmd method moving squre
...
###################  setting marker  #######################
 def init_markers(self):
  ...
  # Define a marker publisher topic name.
  self.marker_pub = rospy.Publisher('sub_station_markers', Marker, queue_size=10)
...
########################## starting ##########################
 def __init__(self):
  ...
  square_size = rospy.get_param("~square_size", 2.0) # in meters
