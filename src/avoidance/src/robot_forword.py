#!/usr/bin/env python
""" 
- Version 1.0 2015/25/9

this is the motion module --- robot forward with auto avoidance.
...
'LeftWarning':-1,'LeftDanger':-2,'LeftHDanger':-3}  
  ...
  self.defineSP={'EXHDanger':0.2,'HDanger':0.4,'Danger':0.6,'Warning':0.8,'Unknown':1.0,'AllClear':1.1,'FrontObstacle':0}
