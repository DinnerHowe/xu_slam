...
add_custom_target(rplidar_python_generate_messages ALL)
...
_generate_module_cpp(rplidar_python
  ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/rplidar_python
  "${ALL_GEN_OUTPUT_FILES_cpp}"
)

add_custom_target(rplidar_python_generate_messages_cpp
...
add_dependencies(rplidar_python_gencpp rplidar_python_generate_messages_cpp)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS rplidar_python_generate_messages_cpp)
...
### Generating Module File
_generate_module_lisp(rplidar_python
  ${CATKIN_DEVEL_PREFIX}/${genlisp_INSTALL_DIR}/rplidar_python
  "${ALL_GEN_OUTPUT_FILES_lisp}"
)

add_custom_target(rplidar_python_generate_messages_lisp
...
add_dependencies(rplidar_python_genlisp rplidar_python_generate_messages_lisp)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS rplidar_python_generate_messages_lisp)
...
### Generating Module File
_generate_module_py(rplidar_python
  ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/rplidar_python
  "${ALL_GEN_OUTPUT_FILES_py}"
)

add_custom_target(rplidar_python_generate_messages_py
...
add_dependencies(rplidar_python_genpy rplidar_python_generate_messages_py)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS rplidar_python_generate_messages_py)



if(gencpp_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/rplidar_python)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/rplidar_python
    DESTINATION ${gencpp_INSTALL_DIR}
  )
endif()
add_dependencies(rplidar_python_generate_messages_cpp std_msgs_generate_messages_cpp)
add_dependencies(rplidar_python_generate_messages_cpp geometry_msgs_generate_messages_cpp)

if(genlisp_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genlisp_INSTALL_DIR}/rplidar_python)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${genlisp_INSTALL_DIR}/rplidar_python
    DESTINATION ${genlisp_INSTALL_DIR}
  )
endif()
add_dependencies(rplidar_python_generate_messages_lisp std_msgs_generate_messages_lisp)
add_dependencies(rplidar_python_generate_messages_lisp geometry_msgs_generate_messages_lisp)

if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/rplidar_python)
  install(CODE "execute_process(COMMAND \"/usr/bin/python\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/rplidar_python\")")
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/rplidar_python
    DESTINATION ${genpy_INSTALL_DIR}
  )
endif()
add_dependencies(rplidar_python_generate_messages_py std_msgs_generate_messages_py)
add_dependencies(rplidar_python_generate_messages_py geometry_msgs_generate_messages_py)
