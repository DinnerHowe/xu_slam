...
if("FALSE" STREQUAL "TRUE")
  set(base_motion_module_SOURCE_PREFIX /home/turtlebot/xu_slam/src/base_motion_module)
  set(base_motion_module_DEVEL_PREFIX /home/turtlebot/xu_slam/devel)
  ...
  set(base_motion_module_INSTALL_PREFIX /home/turtlebot/xu_slam/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'base_motion_module' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/turtlebot/xu_slam/install/${idir}'.  Ask the maintainer 'turtlebot2 <turtlebot2@todo.todo>' to fix it.")
    endif()
