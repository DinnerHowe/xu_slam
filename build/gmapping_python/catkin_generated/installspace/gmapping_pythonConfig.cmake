...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'gmapping_python' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/turtlebot/xu_slam/install/${idir}'.  Ask the maintainer 'zhihao xu(Howe) <zhihao@iscas.ac.cn>, turtlebot <turtlebot@todo.todo>' to fix it.")
    endif()
